...
function authHeaders(session) {
  // ACLED's data endpoints sit behind Cloudflare bot protection. A bare
  // "Crucix/1.0" UA gets a 403 "Just a moment..." challenge page even when
  // the OAuth token is perfectly valid — the failure looks like an auth
