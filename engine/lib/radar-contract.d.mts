...
export interface Snapshot {schema:2;id:string;generatedAt:string;sweepMs:number;analysisStatus:'complete'|'degraded';digest:Localized;events:RadarEvent[];markets:Quote[];sources:Source[];forecast:Forecast|null}
