...
export interface RadarEvent {id:string;source:string;url:string;category:'ai'|'japan-residence'|'japan-life'|'geopolitics'|'crypto'|'stocks';publishedAt:string|null;fetchedAt:string;stage:'announcement'|'draft'|'open'|'closed'|'withdrawn'|'unknown';deadlineAt:string|null;title:Localized;summary:Localized;audience:Localized;action:Localized;unknowns:Localized;evidence:string;change:'new'|'updated'|'unchanged'}
