...
function StoryRail({steps,currentId,l,w}:{steps:Step[];currentId:string;l:Locale;w:Record<string,string>}){
  ...
  const label=(days>0?w.threadSpan:w.threadToday).replace('{n}',String(steps.length)).replace('{d}',String(days));
